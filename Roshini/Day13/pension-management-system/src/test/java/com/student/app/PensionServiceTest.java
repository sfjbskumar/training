...
class PensionServiceTest{
    ...
    void testGetAllApplicants(){
        when(pensionRepository.findAll()).thenReturn(Stream
                .of(new PensionBuilder().setId(201).setName("Sudha").setAge(21).setBalance(80000).setMobile("999999655").setEmpStatus("A").setPensionStatus("N").setPensionMMYY("0922").setInstallment(1000).createPension(),
    ...
    void testGetApplicantById(){
        ...
        pensionBuilder.setName("Sudha");
        pensionBuilder.setAge(21);
        pensionBuilder.setBalance(80000);
        pensionBuilder.setMobile("9999776655");
