...
@WebMvcTest(PensionController.class)
 class PensionControllerTest {
    ...
    void deleteApplication() throws Exception {
        ...
        String URI = "/delete/applicant/1";

        Mockito.when(pensionService.delete(1)).thenReturn("Delete Success.");

        //Mockito.when(pensionService.delete(1)).thenReturn();
        mockMvc.perform(MockMvcRequestBuilders.delete("/delete/applicant/1"))
