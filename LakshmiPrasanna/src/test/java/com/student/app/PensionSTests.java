...
class PensionServiceTest{
    ...
    void testGetAllApplicants(){
        when(pensionRepository.findAll()).thenReturn(Stream
                .of(new PensionBuilder().setId(201).setName("prasanna").setAge(21).setBalance(80000).setMobile("9988776655").setEmpStatus("A").setPensionStatus("N").setPensionMMYY("0922").setInstallment(1000).createPension(),
                        new PensionBuilder().setId(202).setName("chandini").setAge(60).setBalance(90000).setMobile("8899776655").setEmpStatus("R").setPensionStatus("Y").setPensionMMYY("0922").setInstallment(1200).createPension()).collect(Collectors.toList()));
    ...
    void testGetApplicantById(){
        ...
        pensionBuilder.setName("prasanna");
        pensionBuilder.setAge(21);
        pensionBuilder.setBalance(80000);
        pensionBuilder.setMobile("9988776666");
    ...
    void testDelete(){
        int id=201;
        Pension p = new PensionBuilder().setId(id).setName("prasanna").setAge(21).setBalance(80000).setMobile("9988776655").setEmpStatus("A").setPensionStatus("N").setPensionMMYY("0922").setInstallment(1000).createPension();
