package com.harini.app.CalculatorApplication.controller;
...
public class CalculatorController
{
    ...
    { return a+b; }
    @GetMapping("sub")
    public float subtract(@RequestParam(name = "a", required = true) float a, @RequestParam(name = "b", required = true) float b)
    { return a-b; }
    @GetMapping("mul")
