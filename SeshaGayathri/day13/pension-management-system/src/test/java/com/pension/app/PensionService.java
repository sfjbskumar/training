...
class PensionServiceTest{
    ...
    void testGetAllPension(){
        ...
        assertEquals(2, pensionService.getAllPension().size());
    }

    @Test
    void testGetPensionById(){
        int id=201;
        PensionBuilder pensionBuilder = new PensionBuilder();
        pensionBuilder.setId(id);
        pensionBuilder.setName("Rahul");
        ...
        Pension pensioner = pensionService.getPensionById(id);
        ...
        assertEquals(p.getPenmmyy(), pensioner.getPenmmyy());
    ...
    void testDelete(){
        int id=201;
        Pension p = new PensionBuilder().setId(id).setName("Rahul").setAge(21).setBalance(80000).setMobile("9988776655").setEmpStatus("A").setPensionStatus("N").setPensionMMYY("0922").setInstallment(1000).createPension();
