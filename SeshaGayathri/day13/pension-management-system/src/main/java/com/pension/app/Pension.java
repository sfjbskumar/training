...
public class Pension {
    ...
    public Pension(int id, String name, int age, int balance, String phone, String empstatus, String pensionStatus, String pensionMMYY, int installment) {
   this.id=id;
   this.name=name;
   this.age=age;
   ...
   this.penstatus=pensionStatus;
   this.penmmyy=pensionMMYY;
